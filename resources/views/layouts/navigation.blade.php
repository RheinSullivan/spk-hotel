            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if (Auth::user()->role === 'admin')
                        ...
                        <x-nav-link :href="route('bobot-kriteria.index')" :active="request()->routeIs('bobot-kriteria.*')">
                            {{ __('Bobot Kriteria') }}
                        </x-nav-link>
    ...
    <div :class="{ 'block': open, 'hidden': ! open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (Auth::user()->role === 'admin')
                ...
                <x-responsive-nav-link :href="route('bobot-kriteria.index')" :active="request()->routeIs('bobot-kriteria.*')">
                    {{ __('Bobot Kriteria') }}
                </x-responsive-nav-link>
